...
public class Constants {
    ...
    public static final String VENDOR_BANK_BRANCH = "VENDOR_BANK_BRANCH";
    public static final String VENDOR_BANK_IFSC_CODE = "VENDOR_BANK_IFSC_CODE";
    public static final String VENDOR_AREA_NAME = "VENDOR_AREA_NAME";
    public static final String VENDOR_GARAGE_NAME = "VENDOR_GARAGE_NAME";
    public static final String VENDOR_DISTRICT = "VENDOR_DISTRICT";
